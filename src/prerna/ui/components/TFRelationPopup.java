...
public class TFRelationPopup extends JMenu implements MouseListener{
	...
	public TFRelationPopup(String name, IPlaySheet ps, DBCMVertex [] pickedVertex)
	{
		super(name);
	...
	public void addRelations(String prefix)
	{
		...
		for(int pi = 0;pi < pickedVertex.length;pi++)
		{
			...
			String fileName = "";
			Vector <DBCMVertex> vertVector = ((GraphPlaySheet)ps).filterData.getNodes(type);
			System.out.println("Vert vector size is " + vertVector.size());
